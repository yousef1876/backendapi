<div class="smart-style-4 body-container menu-on-top" id="wrapper">
		...
		<header id="header">
			...
			<div id="headerdiv" class="pull-right">
			...
			<nav>
				...
				<ul>
					...
					<li>
						...
						<ul>
							<li>
								<a href="/ngapp/#/register"><spring:message code="ngapp.registration"/></a>
							</li>
							<li>
								<a href="/ngapp/#/seccode"><spring:message code="ngapp.secret.code"/></a>
			...
			<div id="content">
              <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<header>
					...
					<h2><spring:message code="ngapp.registration.form"/></h2>				
						...
						<form id="order-form" class="smart-form" novalidate="novalidate">
							...
							<fieldset>
								<div class="row" data-ng-controller="InitCtrl1" data-ng-init="init()">
									...
									<label class="form-control"><spring:message code="ngapp.mobile.number"/></label>
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="text" id="mobile" name="mobile" 
											class = "form-control"
                                            ng-model = "form.blur"
                       
                                            invalid-message="'Invalid Text'"
									...
									<section class="col col-6" >
									<label class="form-control"><spring:message code="ngapp.secret.code"/></label>
										<label class="input"> <i class="icon-append fa fa-user"></i>
							...
							<footer>
								<button type="submit" class="btn btn-primary" ng-click="registration()">
									<spring:message code="ngapp.code.next"/>
								</button>
							</footer>
						</form>
