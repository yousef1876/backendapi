			...
			<nav>
				...
				<ul>
					...
					<li>
						...
						<ul>
							<li>
								<a href="/ngapp/#/register" >  <spring:message code="ngapp.registration"></spring:message>   </a>
							</li>
							<li>
								<a href="/ngapp/#/seccode"><spring:message code="ngapp.secret.code"></spring:message></a>
			...
			<div id="content">
              <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<header>
					...
					<h2> <spring:message code="ngapp.secret.form"></spring:message></h2>				
					...
					<div class="widget-body no-padding">
						...
						<form id="secform" class="smart-form"  class="form-horizontal" novalidate >
							...
							<fieldset>
								<div class="row" data-ng-controller="InitCtrl1" data-ng-init="init()">
									<section class="col col-6">
									   <spring:message code="ngapp.mobile.secret.code"></spring:message>
							...
							<button type="submit" class="btn btn-primary" ng-click="redirect()">
									<spring:message code="ngapp.code.next"></spring:message>
								</button>
								<button type="submit" class="btn btn-primary" ng-click="secretcode()">
									<spring:message code="ngapp.code.send"></spring:message>
								</button>
							</footer>
						</form>
